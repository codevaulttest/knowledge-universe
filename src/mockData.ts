...
/** 消息只服务小黄车商城：买卖双方沟通（trade）＋ 客服介入纠纷的独立工单（support） */
export const DM_CONVERSATIONS: DmConversation[] = [
  {
    ...
    kind: 'trade',
    orderId: 'ord-2001',
    productTitle: '我的手作机械键盘（客制化 · 静电容轴）',
    lastMessage: '好的，那我等你发货，辛苦啦！',
    lastTime: '10 分钟前',
    unread: 2,
    messages: [
      { id: 'm1', from: 'peer', text: '老板，键盘拍下了，静电容轴是原厂的吗？', time: '今天 09:14' },
      { id: 'm2', from: 'me', text: '是的，原厂静电容，配列已经按你备注的改成 68 键了', time: '今天 09:31' },
      { id: 'm3', from: 'peer', text: '太好了。大概什么时候能发出来？我这边急着周末用', time: '今天 09:35' },
      { id: 'm4', from: 'me', text: '今天下午焊完最后一批轴就发，走顺丰，明天应该能到', time: '今天 10:02' },
      { id: 'm5', from: 'peer', text: '收到，发货了麻烦把单号发我一下', time: '10 分钟前' },
      { id: 'm6', from: 'peer', text: '好的，那我等你发货，辛苦啦！', time: '10 分钟前' },
    ],
  },
  {
    id: 'dm2',
    ...
    kind: 'trade',
    orderId: 'ord-1002',
    productTitle: 'AI 产品截图 × 提示词模板合集',
    lastMessage: '素材包今晚整理好就发你',
    lastTime: '1 小时前',
    unread: 1,
    messages: [
      { id: 'm1', from: 'me', text: '你好，刚下单了模板合集，请问是发网盘链接还是站内下载？', time: '今天 13:22' },
      { id: 'm2', from: 'peer', text: '站内下载，付款后订单页就能看到下载入口', time: '今天 13:40' },
      { id: 'm3', from: 'me', text: '好的。截图那部分包含 Figma 源文件吗？', time: '今天 13:45' },
      { id: 'm4', from: 'peer', text: '包含的，源文件在压缩包的 /figma 目录下', time: '今天 14:01' },
      { id: 'm5', from: 'peer', text: '素材包今晚整理好就发你', time: '1 小时前' },
    ],
  },
  {
    id: 'dm3',
    ...
    kind: 'trade',
    orderId: 'ord-1001',
    productTitle: '「知识星探」联名马克杯 · 陶瓷 400ml',
    lastMessage: '已经走顺丰了，单号在订单页可以查',
    lastTime: '昨天',
    unread: 0,
    messages: [
      { id: 'm1', from: 'me', text: '你好，两个杯子麻烦分开包一下，是送人的', time: '前天 09:11' },
      { id: 'm2', from: 'peer', text: '好的，都加了气泡柱，外面再套一层纸箱', time: '前天 09:34' },
      { id: 'm3', from: 'me', text: '谢谢！大概几天能到上海？', time: '前天 10:00' },
      { id: 'm4', from: 'peer', text: '顺丰的话隔天就到，今天下午出仓', time: '前天 10:22' },
      { id: 'm5', from: 'peer', text: '已经走顺丰了，单号在订单页可以查', time: '昨天' },
    ],
  },
  {
    id: 'dm-support-1003',
    ...
    orderId: 'ord-1003',
    productTitle: '「知识星探」联名马克杯 · 陶瓷 400ml',
    lastMessage: '已收到你的举证，我们同步联系卖家核实，48 小时内给出处理结论',
    lastTime: '2 小时前',
    unread: 1,
    messages: [
      { id: 'm1', from: 'me', text: '这单收到时杯子有磕口，申请退款卖家一直没回复', time: '今天 11:05' },
      { id: 'm2', from: 'peer', text: '你好，我是本单的处理专员。麻烦上传一下开箱照片和磕口特写', time: '今天 11:20' },
      { id: 'm3', from: 'me', text: '[图片] 开箱视频截图 · 杯口缺角', time: '今天 11:26' },
      { id: 'm4', from: 'peer', text: '收到，已调取你与卖家的沟通记录和物流签收信息', time: '今天 11:48' },
      { id: 'm5', from: 'peer', text: '已收到你的举证，我们同步联系卖家核实，48 小时内给出处理结论', time: '2 小时前' },
    ],
  },
];
