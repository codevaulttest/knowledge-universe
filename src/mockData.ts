...
export const ALL_CHANNELS: Channel[] = [
  ...
  },
  {
    ...
    tiers: [
      { id: 'jike-1', name: '金牌', price: 30 },
      { id: 'jike-2', name: '银牌', price: 150 },
      { id: 'jike-3', name: '铜牌', price: 400 },
    ],
    subscriberCount: 215, createdAt: '2026-04-22',
  },
  {
    // 该频道档位数早于「最多 3 档」的规则上线，保留 5 档作为老频道被延续保护（grandfathered）的示例：
    // 新频道最多只能设 3 档，但已有的超额档位不会被强制收缩
    ...
    tiers: [
      { id: 'aieff-1', name: '金牌', price: 20 },
      { id: 'aieff-2', name: '银牌', price: 60 },
      { id: 'aieff-3', name: '铜牌', price: 150 },
      { id: 'aieff-4', name: '钻石', price: 350 },
      { id: 'aieff-5', name: '至尊', price: 800 },
    ],
...
export const CHANNEL_SUBSCRIBERS: Record<string, ChannelSubscriber[]> = {
  'channel-amay': [
    ...
    { name: '设计师刘然', avatarIdx: 0, tierName: '金牌', subscribedAt: '5 天前' },
    { name: '深海鱼炸弹', avatarIdx: 0, tierName: '金牌', subscribedAt: '1 周前' },
    { name: '极客前沿', avatarIdx: 1, tierName: '银牌', subscribedAt: '2 周前' },
    { name: '产品大叔严磊', avatarIdx: 2, tierName: '金牌', subscribedAt: '3 周前' },
  ],
  'channel-yanlei': [
    { name: '游牧开发者', avatarIdx: 2, tierName: '金牌', subscribedAt: '1 天前' },
    { name: '阿May的研究笔记', avatarIdx: 1, tierName: '金牌', subscribedAt: '4 天前' },
    { name: '设计师刘然', avatarIdx: 0, tierName: '金牌', subscribedAt: '1 周前' },
  ],
  'channel-jike': [
    { name: 'AI 效率研究所', avatarIdx: 0, tierName: '铜牌', subscribedAt: '3 小时前' },
    { name: '阿May的研究笔记', avatarIdx: 1, tierName: '银牌', subscribedAt: '昨天' },
    { name: '游牧开发者', avatarIdx: 2, tierName: '金牌', subscribedAt: '3 天前' },
    { name: '深海鱼炸弹', avatarIdx: 0, tierName: '银牌', subscribedAt: '1 周前' },
    { name: '设计师刘然', avatarIdx: 0, tierName: '金牌', subscribedAt: '2 周前' },
    { name: '产品大叔严磊', avatarIdx: 2, tierName: '铜牌', subscribedAt: '1 个月前' },
  ],
  'channel-aieff': [
    { name: '阿May的研究笔记', avatarIdx: 1, tierName: '至尊', subscribedAt: '1 小时前' },
    { name: '游牧开发者', avatarIdx: 2, tierName: '银牌', subscribedAt: '昨天' },
    { name: '设计师刘然', avatarIdx: 0, tierName: '金牌', subscribedAt: '2 天前' },
    { name: '极客前沿', avatarIdx: 1, tierName: '钻石', subscribedAt: '5 天前' },
    { name: '深海鱼炸弹', avatarIdx: 0, tierName: '铜牌', subscribedAt: '1 周前' },
    { name: '产品大叔严磊', avatarIdx: 2, tierName: '金牌', subscribedAt: '2 周前' },
  ],
  // 分组展示用：同档位按订阅时间从新到旧排列
  'channel-lin': [
    { name: '阿May的研究笔记', avatarIdx: 1, tierName: '钻石', subscribedAt: '2 小时前' },
    { name: 'AI 效率研究所', avatarIdx: 0, tierName: '铜牌', subscribedAt: '昨天' },
    { name: '极客前沿', avatarIdx: 1, tierName: '铜牌', subscribedAt: '5 天前' },
    { name: '游牧开发者', avatarIdx: 2, tierName: '银牌', subscribedAt: '2 天前' },
    { name: '深海鱼炸弹', avatarIdx: 0, tierName: '银牌', subscribedAt: '1 周前' },
    { name: '设计师刘然', avatarIdx: 0, tierName: '金牌', subscribedAt: '4 天前' },
    { name: '产品大叔严磊', avatarIdx: 2, tierName: '金牌', subscribedAt: '2 周前' },
  ],
};
...
export const POST_REPLIES: Record<string, Reply[]> = {
  p1: [
    ...
    { id: 'r1b', author: '深海鱼炸弹', time: '2 小时前', text: '哪个工具最好用？最近在对比 Claude 和 GPT-4o。', avatarIdx: 2, likes: 8, channelTierName: '铜牌' },
    { id: 'r1c', author: '极客前沿', time: '2 小时前', text: '提示词模板那部分很有价值，已收藏。', avatarIdx: 0, likes: 15, channelTierName: '至尊' },
    { id: 'r1d', author: '设计师刘然', time: '2 小时前', text: '我也整理过类似的合集，感觉你总结的更系统一些。', avatarIdx: 0, likes: 6 },
    { id: 'r1e', author: '产品大叔严磊', time: '3 小时前', text: '对 B 端产品设计有很好的借鉴作用，马住！', avatarIdx: 1, likes: 3, channelTierName: '金牌' },
